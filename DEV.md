...
- [ ] `dev/dev-bugscal3b-2026-07-27T17:07-backend-recurrence-expansion.md` — Backend server-side recurrence expansion in ListMealEvents. Status: ready. Blocked-by: —. From: epic-bugs-calendar-ux (unblocks the deferred bugs-cal-3 recurrence UI).
- [ ] `dev/dev-bugsact2a-2026-07-27T17:08-backend-fields-addendum.md` — Backend fields addendum for import-item detail (last_successful_stage, last_retry_at, confidence_score). Status: ready. Blocked-by: —. Verify-first: irrd-1/irrd-3 may have already delivered parts.
