...
- "notes": preparation or state qualifiers ("chopped", "minced", "sauteed", "room temperature", "divided", "to taste") or null. Do NOT hallucinate notes — if the source has no qualifier, notes MUST be null.
