...
class ErrorCode(BaseEnum):
    ...
    MEAL_EVENT_RECIPE_XOR_MEAL = 135
    ...
    INVITATION_NOT_FOUND = 240
    INVITATION_ACCESS_DENIED = 241
    INVITATION_ALREADY_SENT = 242
    INVITATION_EXPIRED = 243
    INVITATION_NOT_PENDING = 244
    INVITATION_INVALID_RESOURCE_TYPE = 245
    INVITATION_INVALID_ROLE = 246
    INVITATION_SELF_INVITE = 247
    INVITATION_ALREADY_MEMBER = 248

    # Invite Link errors (250-259)
    INVITE_LINK_NOT_FOUND = 250
    INVITE_LINK_INACTIVE = 251
    INVITE_LINK_EXPIRED = 252
    ...
    MEAL_EVENT_CALENDAR_REQUIRED = 264
    RECURRENCE_RULE_CALENDAR_REQUIRED = 265
    CALENDAR_OWNER_TRANSFER_REQUIRED = 266
    CALENDAR_INVALID_ROLE = 267
    CALENDAR_OWNER_TRANSFER_CONFLICT = 268
    CALENDAR_OWNER_CANNOT_LEAVE = 269
    ...
    # Share / file-upload errors (290-299)
    FILE_TOO_LARGE = 290
    UNSUPPORTED_MIME = 291
    OBJECT_NOT_READY = 292
    CROSS_USER_KEY = 293
    DUPLICATE_IMPORT = 294

    # Meal errors (300-319)
    MEAL_NOT_FOUND = 300
    MEAL_ACCESS_DENIED = 301
    MEAL_COMPONENT_UNREADABLE = 302
    MEAL_COMPONENT_DUPLICATE = 303
    MEAL_MIN_COMPONENTS = 304
    MEAL_REORDER_MISMATCH = 305
    MEAL_COMPONENT_UNAVAILABLE = 306
    MEAL_ALREADY_ARCHIVED = 307
    MEAL_NOT_ARCHIVED = 308
    MEAL_COMPONENT_NOT_FOUND = 309
