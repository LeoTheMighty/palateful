...
@mcp.tool()
def list_recipe_books(limit: int = 20, offset: int = 0) -> str:
    ...
    """
    return call_endpoint(ListRecipeBooks, limit=limit, offset=offset)
...
def create_recipe_book(
    ...
    return call_endpoint(CreateRecipeBook, params=params)
