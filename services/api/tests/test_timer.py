...
class TestUpdateTimerMissingBranches:
    ...
    def test_update_timer_archived(self, client, mock_db, mock_user):
    ...
    def test_update_timer_wrong_user(self, client, mock_db, mock_user):
    ...
    def test_update_timer_invalid_status(self, client, mock_db, mock_user):
    ...
    def test_update_completed_timer_returns_400(self, client, mock_db, mock_user):
    ...
    def test_update_cancelled_timer_returns_400(self, client, mock_db, mock_user):
    ...
    def test_resume_paused_timer(self, client, mock_db, mock_user):
    ...
    def test_complete_running_timer(self, client, mock_db, mock_user):
    ...
    def test_cancel_running_timer(self, client, mock_db, mock_user):
    ...
    def test_add_seconds_to_timer(self, client, mock_db, mock_user):
    ...
    def test_add_seconds_zero_ignored(self, client, mock_db, mock_user):
    ...
    def test_update_timer_no_status_no_add_seconds(self, client, mock_db, mock_user):
