...
class TestGetUploadUrl:
    ...
    def test_get_upload_url_success(
        self, mock_aws_cls, client, mock_async_db, mock_user
    ):
        """Test generating a presigned upload URL."""
        mock_aws = MagicMock()
        mock_aws_cls.return_value = mock_aws
        mock_aws.generate_presigned_upload_url_async = AsyncMock(
...
class TestSubmitParserJob:
    ...
    def test_submit_parser_job_success(
        ...
        mock_aws = MagicMock()
        mock_aws_cls.return_value = mock_aws
        mock_aws.submit_batch_job_async = AsyncMock(return_value="batch-123")
...
class TestGetParserJob:
    ...
    def test_get_parser_job_success(self, client, mock_async_db, mock_user):
        ...
        mock_async_db.set_find_by(ParserJob, job, id=job_id)
    ...
    def test_get_parser_job_not_found(self, client, mock_async_db, mock_user):
        """Test getting a nonexistent parser job."""
        response = client.get("/v1/parser/jobs/nonexistent")
        assert response.status_code == 404

    def test_get_parser_job_wrong_user(self, client, mock_async_db, mock_user):
    ...
    def test_get_parser_job_syncs_pending_status(
        self, mock_aws_cls, client, mock_async_db, mock_user
    ):
        ...
        mock_aws = MagicMock()
        mock_aws_cls.return_value = mock_aws
        mock_aws.describe_batch_job_async = AsyncMock(
        ...
        mock_aws.describe_batch_job_async.assert_awaited_once_with("batch-456")

    @patch("api.v1.parser.get_parser_job.AWSService")
    def test_get_parser_job_syncs_succeeded_fetches_s3(
        self, mock_aws_cls, client, mock_async_db, mock_user
    ):
        ...
        mock_aws.get_s3_object_async = AsyncMock(
            return_value={"extracted_markdown": "# Recipe\nStep 1"}
        )
        ...
        mock_aws.get_s3_object_async.assert_awaited_once_with("results/test.json")

    @patch("api.v1.parser.get_parser_job.AWSService")
    def test_get_parser_job_syncs_succeeded_s3_failure(
        self, mock_aws_cls, client, mock_async_db, mock_user
    ):
    ...
    @patch("api.v1.parser.get_parser_job.AWSService")
    def test_get_parser_job_syncs_failed_captures_reason(
        self, mock_aws_cls, client, mock_async_db, mock_user
    ):
    ...
    @patch("api.v1.parser.get_parser_job.AWSService")
    def test_get_parser_job_syncs_failed_no_reason(
        self, mock_aws_cls, client, mock_async_db, mock_user
    ):
    ...
    def test_get_parser_job_already_succeeded_no_sync(
    ...
    def test_get_parser_job_already_failed_no_sync(
        self, client, mock_async_db, mock_user
    ):
    ...
    def test_get_parser_job_pending_no_batch_job_id_no_sync(
        self, client, mock_async_db, mock_user
    ):
    ...
    @patch("api.v1.parser.get_parser_job.AWSService")
    def test_get_parser_job_succeeded_no_output_key(
        self, mock_aws_cls, client, mock_async_db, mock_user
    ):
        ...
        mock_aws.get_s3_object_async.assert_not_awaited()
...
class TestSubmitBatchParserJob:
    ...
    @patch("api.v1.parser.submit_batch_parser_job.AWSService")
    def test_submit_batch_single_image(
        self, mock_aws_cls, client, mock_async_db, mock_user
    ):
    ...
    @patch("api.v1.parser.submit_batch_parser_job.AWSService")
    def test_submit_batch_aws_service_called_with_manifest(
        self, mock_aws_cls, client, mock_async_db, mock_user
    ):
        ...
        # Verify submit_batch_manifest_job_async was called
    ...
    def test_submit_batch_missing_s3_keys(self, client, mock_async_db, mock_user):
